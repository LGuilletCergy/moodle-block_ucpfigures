...
$string['distinctteachers'] = '{$a->value} different teachers have created courses since {$a->startdate}.<br>';
$string['nblogin'] = '{$a} logins this week.<br>';
$string['nblogin2'] = 'Logins this week<br>';
$string['nbgrades'] = '{$a->value} grades given since {$a->startdate}.<br>';
$string['nbfiles'] = '{$a->value} files uploaded since {$a->startdate}.<br>';
$string['nbviews'] = '{$a->value} courses or files viewed since {$a->startdate}.<br>';
$string['nbactions'] = '{$a->value} actions taken since {$a->startdate}.<br>';