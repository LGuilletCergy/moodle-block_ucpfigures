...
$string['nbvets'] = 'Nombre de promotions déclarées';
...
$string['nbstudents'] = 'Nombre d\'étudiants déclarés';
...
$string['nbcourses'] = 'Nombre de cours déclarés';
$string['courses'] = 'Cours déclarés';
...
$string['nbassigns'] = '{$a->value} cours utilisant un module Big Blue Buttons depuis le {$a->startdate}.<br><br>';
