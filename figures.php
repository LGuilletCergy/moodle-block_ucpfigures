...
if (!$csv) {
    ...
    echo get_string('introavailablecourses', 'block_ucpfigures', $totalavailablecourses);
    ...
    $nbfolders = $DB->get_record('block_ucpfigures_stats', array('name' => 'folders'))->value;
    $datastringfolders = new stdClass();
    $datastringfolders->value = $nbfolders;
    $datastringfolders->startdate = '01/07/'.$CFG->thisyear;
    echo get_string('nbfolders', 'block_ucpfigures', $datastringfolders);
    ...
    $nbbbb = $DB->get_record('block_ucpfigures_stats', array('name' => 'bbb'))->value;
    $datastringbbb = new stdClass();
    $datastringbbb->value = $nbbbb;
    $datastringbbb->startdate = '01/07/'.$CFG->thisyear;
    echo get_string('nbbbb', 'block_ucpfigures', $datastringbbb);
