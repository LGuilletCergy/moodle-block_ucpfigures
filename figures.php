...
foreach ($composantes as $composante) {
    ...
    $DB->set_field('block_ucpfigures_ufr', 'nbvets', $nbrvets, array('id' => $composante->id));
...
foreach ($composantes as $composante) {
    ...
    $DB->set_field('figures_ufr', 'nbstudents', $nbknownstudentsincomposante, array('id' => $composante->id));
...
foreach ($composantes as $composante) {
    ...
    $DB->set_field('figures_ufr', 'nbcourses', $nbknowncourses, array('id' => $composante->id));
...
foreach ($composantes as $composante) {
    ...
    $DB->set_field('figures_ufr', 'nbavailablecourses', $nbavailcourses, array('id' => $composante->id));
...
foreach ($composantes as $composante) {
    ...
    $DB->set_field('figures_ufr', 'nbavailablevets', $nbrpromotions, array('id' => $composante->id));
...
foreach ($composantes as $composante) {
    ...
    $DB->set_field('figures_ufr', 'nbcreatedcourses', $nbcoursesincomposante, array('id' => $composante->id));
...
foreach ($composantes as $composante) {
    ...
    $DB->set_field('figures_ufr', 'nbactivestudents', $nbactivestudentsincomposante, array('id' => $composante->id));
    ...
    $DB->set_field('figures_ufr', 'nbenroledstudents', $nbstudentsincomposante, array('id' => $composante->id));
...
$composantes = $DB->get_records('figures_ufr');
foreach ($composantes as $composante) {
...
foreach ($composantes as $composante) {
    ...
    $DB->set_field('figures_ufr', 'nbcreatedvets', $nbpromotions, array('id' => $composante->id));
//    $sql = "SELECT COUNT(DISTINCT vets.id) AS nbrvets
//	    FROM `mdl_cat_demandecours` niveau, mdl_cat_demandecours vets
//	    WHERE niveau.id = vets.parent_id AND niveau.parent_id = '".$composante["idcat"]."'";
//    $nbrvets = $DB->get_record_sql($sql)->nbrvets;
...
$sql = "SELECT number FROM mdl_block_ucpfigures WHERE name = 'weekconnections'";
...
$sql = "SELECT number FROM mdl_figures WHERE name = 'nbgrades'";
...
$sql = "SELECT number FROM mdl_block_ucpfigures WHERE name = 'nblogs'";
